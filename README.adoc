...
ANF is a 2D framework in Rust. It's powered by https://github.com/FNA-XNA/FNA3D[FNA3D] & https://www.libsdl.org/[SDL2], which runs on desktops.

== About

ANF is just for https://github.com/toyboot4e/rlbox[my roguelike game development] and its' a not feature-complete framework. You would only need 5 minutes to get the whole picture.
